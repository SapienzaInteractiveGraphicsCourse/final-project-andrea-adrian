...
import { NearestFilter, WebGLRenderTarget as WebGLRenderTarget3 } from '../three/build/three.module.js';

// src/materials/AdaptiveLuminanceMaterial.js
import { NoBlending, ShaderMaterial, Uniform } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending2, ShaderMaterial as ShaderMaterial2, Uniform as Uniform2, Vector2 } from '../three/build/three.module.js';
...
import { BasicDepthPacking, NoBlending as NoBlending3, PerspectiveCamera, ShaderMaterial as ShaderMaterial3, Uniform as Uniform3 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending4, ShaderMaterial as ShaderMaterial4, Uniform as Uniform4, Vector4 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending5, ShaderMaterial as ShaderMaterial5, Uniform as Uniform5 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending6, PerspectiveCamera as PerspectiveCamera2, RGBADepthPacking, ShaderMaterial as ShaderMaterial6, Uniform as Uniform6 } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking2, NoBlending as NoBlending7, ShaderMaterial as ShaderMaterial7, Uniform as Uniform7, Vector2 as Vector22 } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking3, NoBlending as NoBlending8, ShaderMaterial as ShaderMaterial8, Uniform as Uniform8, Vector2 as Vector23 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending10, ShaderMaterial as ShaderMaterial10, Uniform as Uniform10, Vector2 as Vector25 } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking5, NoBlending as NoBlending11, ShaderMaterial as ShaderMaterial11, Uniform as Uniform11, Vector2 as Vector26 } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking6, NoBlending as NoBlending12, PerspectiveCamera as PerspectiveCamera4, REVISION as REVISION2, ShaderMaterial as ShaderMaterial12, Uniform as Uniform12, Vector2 as Vector27 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending13, ShaderMaterial as ShaderMaterial13, Uniform as Uniform13, Vector2 as Vector28 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending14, ShaderMaterial as ShaderMaterial14, Uniform as Uniform14 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending15, ShaderMaterial as ShaderMaterial15, Uniform as Uniform15 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending16, ShaderMaterial as ShaderMaterial16, Uniform as Uniform16, UnsignedByteType as UnsignedByteType2 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending17, ShaderMaterial as ShaderMaterial17, Uniform as Uniform17, Vector2 as Vector29 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending18, ShaderMaterial as ShaderMaterial18, Uniform as Uniform18, Vector2 as Vector210 } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking7, Matrix4, NoBlending as NoBlending19, PerspectiveCamera as PerspectiveCamera5, ShaderMaterial as ShaderMaterial19, Uniform as Uniform19, Vector2 as Vector211 } from '../three/build/three.module.js';
...
import { NoBlending as NoBlending20, ShaderMaterial as ShaderMaterial20, Uniform as Uniform20, Vector2 as Vector212 } from '../three/build/three.module.js';
...
import { LinearFilter, sRGBEncoding as sRGBEncoding2, UnsignedByteType as UnsignedByteType3, WebGLRenderTarget as WebGLRenderTarget2 } from '../three/build/three.module.js';
...
import { Color as Color2, MeshDepthMaterial, NearestFilter as NearestFilter2, RGBADepthPacking as RGBADepthPacking2, WebGLRenderTarget as WebGLRenderTarget4 } from '../three/build/three.module.js';

// src/core/Resolution.js
import { EventDispatcher, Vector2 as Vector213 } from '../three/build/three.module.js';
var AUTO_SIZE = -1;
...
import { BackSide, DoubleSide, FrontSide } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking9, FloatType, NearestFilter as NearestFilter3, WebGLRenderTarget as WebGLRenderTarget5 } from '../three/build/three.module.js';
...
import { FloatType as FloatType3, RGBADepthPacking as RGBADepthPacking4 } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking11, UnsignedByteType as UnsignedByteType5, sRGBEncoding as sRGBEncoding3 } from '../three/build/three.module.js';
...
import { sRGBEncoding as sRGBEncoding4, UnsignedByteType as UnsignedByteType6, WebGLRenderTarget as WebGLRenderTarget7 } from '../three/build/three.module.js';
...
import { sRGBEncoding as sRGBEncoding5, UnsignedByteType as UnsignedByteType7, WebGLRenderTarget as WebGLRenderTarget8 } from '../three/build/three.module.js';
...
import { UnsignedByteType as UnsignedByteType8, WebGLRenderTarget as WebGLRenderTarget9 } from '../three/build/three.module.js';
...
import { sRGBEncoding as sRGBEncoding6, UnsignedByteType as UnsignedByteType9, Vector2 as Vector214, WebGLRenderTarget as WebGLRenderTarget10 } from '../three/build/three.module.js';
...
import { Color as Color3, MeshNormalMaterial, NearestFilter as NearestFilter5, WebGLRenderTarget as WebGLRenderTarget11 } from '../three/build/three.module.js';
...
import { UnsignedByteType as UnsignedByteType10 } from '../three/build/three.module.js';
...
var EffectComposer = class {
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    ...
    let renderTarget;
    if (multisampling > 0) {
      renderTarget = Number(REVISION3.replace(/\D+/g, "")) < 138 ? new WebGLMultisampleRenderTarget(size.width, size.height, options) : new WebGLRenderTarget12(size.width, size.height, options);
...
import { LinearEncoding as LinearEncoding2 } from '../three/build/three.module.js';
...
import { EventDispatcher as EventDispatcher2, Uniform as Uniform21 } from '../three/build/three.module.js';
...
import { sRGBEncoding as sRGBEncoding8, Uniform as Uniform22, WebGLRenderTarget as WebGLRenderTarget14 } from '../three/build/three.module.js';

// src/effects/Effect.js
import { BasicDepthPacking as BasicDepthPacking12, EventDispatcher as EventDispatcher3, LinearEncoding as LinearEncoding3, Material as Material2, Texture as Texture2, WebGLRenderTarget as WebGLRenderTarget13 } from '../three/build/three.module.js';
...
import { Uniform as Uniform23 } from '../three/build/three.module.js';
...
import { sRGBEncoding as sRGBEncoding9, Uniform as Uniform24 } from '../three/build/three.module.js';
...
import { Uniform as Uniform25 } from '../three/build/three.module.js';
...
import { Uniform as Uniform26, Vector2 as Vector216 } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking13, sRGBEncoding as sRGBEncoding10, Uniform as Uniform27, UnsignedByteType as UnsignedByteType12, WebGLRenderTarget as WebGLRenderTarget15 } from '../three/build/three.module.js';
...
import { Uniform as Uniform28, Vector2 as Vector217 } from '../three/build/three.module.js';
...
import { Uniform as Uniform29 } from '../three/build/three.module.js';
...
import { NearestFilter as NearestFilter6, RepeatWrapping, RGBAFormat as RGBAFormat3, Uniform as Uniform30, Vector2 as Vector218 } from '../three/build/three.module.js';
...
var GlitchEffect = class extends Effect {
  constructor({
    ...
    this.breakPoint = new Vector218(randomFloat(this.delay.x, this.delay.y), randomFloat(this.duration.x, this.duration.y));
...
import { Uniform as Uniform32, Vector2 as Vector220 } from '../three/build/three.module.js';
...
import { Uniform as Uniform33, Vector3 as Vector32 } from '../three/build/three.module.js';
...
import { FloatType as FloatType4, HalfFloatType, Uniform as Uniform34 } from '../three/build/three.module.js';
...
import { Color as Color6, RepeatWrapping as RepeatWrapping2, Uniform as Uniform36, UnsignedByteType as UnsignedByteType15, WebGLRenderTarget as WebGLRenderTarget17 } from '../three/build/three.module.js';
...
import { Uniform as Uniform37, Vector2 as Vector221, Vector4 as Vector42 } from '../three/build/three.module.js';
...
import { Uniform as Uniform38, Vector4 as Vector43 } from '../three/build/three.module.js';
...
import { Uniform as Uniform39, Vector2 as Vector222 } from '../three/build/three.module.js';
...
import { Uniform as Uniform40, Vector2 as Vector223, Vector3 as Vector35 } from '../three/build/three.module.js';
...
import { Uniform as Uniform41 } from '../three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking17, Color as Color9, RepeatWrapping as RepeatWrapping3, RGBAFormat as RGBAFormat5, Uniform as Uniform43, WebGLRenderTarget as WebGLRenderTarget20 } from '../three/build/three.module.js';
...
import { Uniform as Uniform44, UnsignedByteType as UnsignedByteType16 } from '../three/build/three.module.js';
...
import { LinearMipmapLinearFilter, Uniform as Uniform45, WebGLRenderTarget as WebGLRenderTarget21 } from '../three/build/three.module.js';
...
import { Uniform as Uniform46 } from '../three/build/three.module.js';
...
import { FileLoader, Loader, LoadingManager as LoadingManager3 } from '../three/build/three.module.js';
...
import { FileLoader as FileLoader2, Loader as Loader2, LoadingManager as LoadingManager4, Vector3 as Vector36 } from '../three/build/three.module.js';
...
import { Loader as Loader3, LoadingManager as LoadingManager5 } from '../three/build/three.module.js';
